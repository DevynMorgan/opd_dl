...
export default function WarrantPanel({ records, loading, onRefresh }: Props) {
  ...
  const [form, setForm] = useState({
    warrant_number: "ASSIGNING…", warrant_type: "Arrest", person_id: "", subject_first_name: "", subject_last_name: "", subject_dob: "", subject_alias: "", priority: "STANDARD", charge: "",
  ...
  async function save() {
    ...
    try {
      const r = await fetch("/api/warrants", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ ...form, person_id: subjectMode === "existing" ? form.person_id : "", title: form.charge, officer }) });
