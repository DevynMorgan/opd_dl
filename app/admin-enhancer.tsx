    ...
    const render = async () => {
      ...
      try {
        ...
        panel.innerHTML = `
          ...
          <div class="admin-stats">${stat("PEOPLE", c.people, "CHARACTER RECORDS")}${stat("LICENSES", c.licenses, "DRIVER LICENSES")}${stat("OPEN WARRANTS", c.warrants, "WARRANT RECORDS")}${stat("INCIDENTS", c.incidents, "INCIDENT RECORDS")}${stat("MESSAGES", c.messages, "DEPARTMENT MESSAGES")}</div>
