...
async function createSchema(client: PoolClient) {
  ...
  await client.query(`
    ...
    ALTER TABLE incidents ADD COLUMN IF NOT EXISTS case_number TEXT;
    ALTER TABLE incidents ADD COLUMN IF NOT EXISTS description TEXT;
    ALTER TABLE incidents ADD COLUMN IF NOT EXISTS persons_involved TEXT;
    ...
    ALTER TABLE incidents ADD COLUMN IF NOT EXISTS related_warrant TEXT;
